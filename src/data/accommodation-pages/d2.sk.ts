...
export const d2SlovakPageData = createSlovakAccommodationPage(d2EnglishPageData, {
  ...
  detailTitle: "Dom s dvoma spálňami, obývacou izbou a prístupom k Panorama Pool",
  detailHighlights: ["Gigabitová Wi-Fi", "Klimatizácia", "Ventilátor", "Dobre vybavená kuchyňa", "Moderná kúpeľňa"],
  ...
  longDescription: [
    ...
    "Panorama Pool je v sezóne k dispozícii hosťom D1, D2 a Fügeház. Nie je to súkromný bazén iba pre D2.",
  ...
  experienceFacts: [["Panorama Pool", "pre hostí D1, D2 a Fügeház v sezóne"], ["Čas vonku", "záhrada, terasa, gril"], ["Pre deti", "priestor a prírodná atmosféra"], ["V okolí", "Balaton, trasy, vinárstva"]],
  ...
  geoDecision: {
    ...
    lead: "D2 je pohodlný pre 4-6 hostí, s veľkou záhradou, krytou terasou, renovovanou kuchyňou a prístupom k Panorama Pool v sezóne.",
    questions: [
      { iconKey: "pool", question: "Má Dandelion D2 prístup k bazénu?", answer: "Áno. Hostia D2 môžu využívať Panorama Pool spolu s hosťami D1 a Fügeház." },

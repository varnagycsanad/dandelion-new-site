...
export const d2CzechPageData = createCzechAccommodationPage(d2EnglishPageData, {
  ...
  detailTitle: "Rodinný dům se dvěma ložnicemi a krytou terasou",
  ...
  amenities: ["Wi-Fi", "Klimatizace", "Kuchyně", "Koupelna", "Topení", "Zahradní posezení", "Gril", "Parkování"],
  ...
  mapBenefits: [{ label: "Turistické trasy poblíž", icon: "trail" }, { label: "Vinařská oblast", icon: "grapes" }, { label: "Balaton krátkou jízdou", icon: "route" }]
});

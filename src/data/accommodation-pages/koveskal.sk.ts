...
export const koveskalSlovakPageData = createSlovakAccommodationPage(koveskalEnglishPageData, {
  ...
  guests: "anglický rezervačný systém",
  ...
  longDescription: [
    ...
    "Pri Köveskáli vedie slovenská rezervačná výzva do spoločného anglického rezervačného systému SabeeApp."
  ],
  facts: [["Poloha", "Köveskál / oblasť Káli"], ["Charakter", "pokojná dedina"], ["Rezervácia", "anglický SabeeApp"], ["Vhodné na", "pomalé dni"]],
  ...
  highlights: ["Oblasť Káli", "Pokojná dedina", "Anglický booking", "Výlety", "Gastronómia", "Vinárska krajina"],
  reasons: [
  ...
  amenities: ["Wi-Fi", "Kuchyňa", "Kúpeľňa", "Kúrenie", "Parkovanie", "Pokojná poloha", "Výlety v okolí", "Anglický booking"],
  geoDecision: {

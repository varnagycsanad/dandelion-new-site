...
export const royalHomesPageData: AccommodationPageData = {
  seo: {
    title: "Dandelion Royal Homes | Keszthely a Balatonnál",
    description:
      "Dandelion Royal Homes Keszthelyen, a Balaton közelében: 4-6 fős apartman nagy terasszal, parti mólóval és közös tetőteraszos jacuzzival."
  },

...
export const fugehazEnglishPageData: AccommodationPageData = {
  ...
  details: {
    ...
    longDescription: [
      ...
      "Panorama Pool is available in season for guests of D1, D2 and Fügeház. It is not a private pool attached to Fügeház, but part of the nearby D1-D2-Fügeház pool area.",
    ...
    groups: [
      {
        ...
        items: [
          ...
          ["Highlight", "Panorama Pool access"]
        ]
      },
      {
        title: "Outdoor time",
  ...
  geoDecision: {
    ...
    lead: "Fügeház is comfortable for 4 guests and can be extended up to 6 guests with an extra bed. It is a two-level house with panoramic terraces, a grill option and Panorama Pool access.",
    questions: [
      {
        iconKey: "pool",
        question: "Does Fügeház have pool access?",
        answer: "Yes. Fügeház guests can use the Panorama Pool together with guests of D1 and D2."
      },
      {
        iconKey: "family",

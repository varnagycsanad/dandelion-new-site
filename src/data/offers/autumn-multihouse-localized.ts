...
export type AutumnMultiHouseCoupleCopy = Omit<AutumnMultiHouseFamilyCopy, "familyGuide">;
...
const coupleCopyByLang: Record<AutumnCampaignLang, AutumnMultiHouseCoupleCopy> = {
  hu: {
    heroLead: ["Lassítsatok le. Kapcsoljatok ki.", "Válasszátok ki a hozzátok illő Dandelion-házat."],
    heroValueAria: "Mutasd meg, mit jelent a 8% ár-előny", heroValueLabel: "ár-előny · részletek", heroValueAction: "IDE KATTINTS", bookingBadge: "Megéri itt foglalni!",
    benefitsAria: "Közvetlen foglalás előnyei", benefitsKicker: "KÖZVETLEN FOGLALÁS", benefitsTitle: "Közvetlenül éri meg", benefitsLead: "A közvetlen foglalás előnyei:", benefits: ["8% ár-előny a portálokhoz képest", "Azonnali bankkártyás fizetés", "Gyors, átlátható foglalási folyamat", "Közvetlen kapcsolat a szállásadóval"],
    priceDialogKicker: "KÖZVETLEN FOGLALÁS", priceDialogClose: "Bezárás", priceDialogTitle: "Közvetlenül éri meg", priceDialogIntro: "A szabad időpontokat és az árakat közvetlenül a saját foglalási felületünkön nézhetitek meg.", priceDialogStat: "ár-előny a portálokhoz képest", priceDialogBenefits: ["Közvetlen kapcsolat a szállásadóval", "Gyors visszaigazolás", "Rugalmas ügyintézés"], priceDialogCta: "Árak és szabad időpontok",
    moodKicker: "MIÉRT DANDELION ŐSSZEL?", moodTitle: "Az ősz itt másképp telik.", moodIntro: "Borozás, kirándulások, biciklizés, medencés lazulás és a Balaton-felvidék felfedezése — többféle ház, ugyanaz a Dandelion-élmény.", selectionAria: "Választást segítő tippek", selectionKicker: "PÁROS ŐSZI ÖTLETEK", selectionBullets: ["Borozás: fedezzétek fel a környék helyi borászatait, és kóstoljatok együtt a Balaton-felvidék hangulatában.", "Biciklizés: nálunk biciklit is bérelhettek, és indulhat a kaland a balatoni bicikliúton.", "Kirándulás és aktív időtöltés a Balaton-felvidék tájain.", "Romantikus séta a Tapolcai Malom-tónál.", "Badacsonyi őszi hangulat, panoráma és bor a hegyoldaláról.", "Lazulás a szeptember végéig nyitva tartó medencében.", "Pezsgő- és virágbekészítés kérésre.", "A Szent György-hegy bazaltorgonái.", "Különleges vacsora a Taberna Infinitó balatoni panorámaéttermében, a Szent György-hegyen.", "Csodálatos kilátás a Szent György-hegyről a Balatonra, a Szigligeti-hegyekre és Badacsonyra.", "A Folly Arborétum és a keszthelyi Festetics-kastély felfedezése."],
    moodCards: [{ label: "PANORÁMA", title: ["Reggel másképp", "indul a nap."], copy: "Panoráma, terasz, csend." }, { label: "MEGHITTSÉG", title: ["Hideg kint.", "Meleg bent."], copy: "Kandalló, saját tér, meghitt esték." }, { label: "BORVIDÉK", title: ["Egy pohár bor.", "Egy hosszú este."], copy: "Borászatok, lassú délutánok, közös beszélgetések." }],
    pickerTitle: "Melyik ház illik hozzátok?", pickerLead: "Ezeket a házakat különböző őszi pihenésekhez ajánljuk, de természetesen azt válasszátok, amelyik igazán megtetszik nektek.", houseLabel: "Akkor válasszátok, ha…", houseWhy: "Miért ajánljuk?", houseView: "Megnézem a házat", recommendations: { d2: "kényelmesebb, kandallós tér", fugehaz: "panorámás páros pihenés", zsalya: "intimebb elvonulás", szololiget: "kisebb, csendesebb ház", vintage: "nyugodt balatoni esték", koveskal: "falusi, borvidéki csend", royal_homes: "Balaton és jakuzzi", szepvolgyi: "nagy balatoni panoráma" }, houseBullets: { d2: ["Kandallós őszi estékre vágytok.", "Egy jól felszerelt konyhában együtt főznétek.", "Fontos nektek a nyugalom és a csend.", "Szükségetek van gyors Wi-Fi-re.", "A medence szeptember végéig használható."], fugehaz: ["A tanúhegyekre néző kávéval és napfelkeltével indítanátok a reggelt.", "Szükségetek van gyors Wi-Fi-re.", "A kert végéből túraút indul a bazaltorgonákhoz.", "Saját, ingyenes parkoló tartozik hozzá.", "A kandalló meghitté teszi az estéket.", "A medence szeptember végéig használható."] },
    directDiscountLabel: "ár-előny a portálokhoz képest", directBenefits: ["Közvetlen kapcsolat a szállásadóval", "Gyors visszaigazolás", "Rugalmas ügyintézés"], bookingCta: "Árak és szabad időpontok", contactCta: "Írásban érdeklődöm", whatsappCta: "WhatsApp"
  },
  en: {
    heroLead: ["Slow down. Switch off.", "Choose the Dandelion house that fits you best."], heroValueAria: "See what the 8% price advantage means", heroValueLabel: "price advantage · details", heroValueAction: "SEE DETAILS", bookingBadge: "Booking direct pays off!",
    benefitsAria: "Benefits of booking direct", benefitsKicker: "DIRECT BOOKING", benefitsTitle: "Booking direct pays off", benefitsLead: "The benefits of booking direct:", benefits: ["8% price advantage compared with portals", "Instant card payment", "Fast, transparent booking process", "Direct contact with your host"],
    priceDialogKicker: "DIRECT BOOKING", priceDialogClose: "Close", priceDialogTitle: "Booking direct pays off", priceDialogIntro: "Check availability and prices directly on our own booking page.", priceDialogStat: "price advantage vs booking portals", priceDialogBenefits: ["Direct contact with your host", "Fast confirmation", "Flexible assistance"], priceDialogCta: "Prices & availability",
    moodKicker: "WHY DANDELION IN AUTUMN?", moodTitle: "Autumn feels different here.", moodIntro: "Wine tasting, walks, cycling, time by the pool and discovering the Balaton Uplands — different houses, the same Dandelion feeling.", selectionAria: "Tips to help you choose", selectionKicker: "AUTUMN IDEAS FOR TWO", selectionBullets: ["Wine tasting: discover the local wineries and share the Balaton Uplands atmosphere.", "Cycling: hire bikes from us and set off along the Lake Balaton cycle path.", "Walks and active time in the hills of the Balaton Uplands.", "A romantic walk around Tapolca Lake.", "Autumn in Badacsony, with views and wine from the hillside.", "Relax by the pool, available until the end of September.", "Champagne and flowers can be arranged on request.", "The basalt organs of Szent György Hill.", "A special dinner at Taberna Infinitó, the panoramic restaurant on Szent György Hill.", "Wonderful views from Szent György Hill towards Lake Balaton, Szigliget and Badacsony.", "Folly Arboretum and Festetics Palace in Keszthely."],
    moodCards: [{ label: "PANORAMA", title: ["Mornings start", "differently."], copy: "Views, a terrace and quiet." }, { label: "COSY EVENINGS", title: ["Cool outside.", "Warm inside."], copy: "A fireplace, your own space and slow evenings." }, { label: "WINE COUNTRY", title: ["A glass of wine.", "A long evening."], copy: "Wineries, slow afternoons and conversations together." }],
    pickerTitle: "Which house fits you best?", pickerLead: "These houses suit different kinds of autumn breaks — choose the one that feels right for you.", houseLabel: "Choose this house if…", houseWhy: "Why we recommend it", houseView: "View the house", recommendations: { d2: "more space and a fireplace", fugehaz: "a panoramic escape for two", zsalya: "a more intimate retreat", szololiget: "a smaller, quieter house", vintage: "slow evenings by the Balaton", koveskal: "village and wine-country calm", royal_homes: "Lake Balaton and a jacuzzi", szepvolgyi: "wide-open Balaton views" }, houseBullets: { d2: ["You would like autumn evenings by the fireplace.", "You want to cook together in a well-equipped kitchen.", "Peace and quiet matter to you.", "Fast Wi-Fi is important.", "The pool can be used until the end of September."], fugehaz: ["You would like coffee with a view of the witness hills and sunrise.", "Fast Wi-Fi is important.", "A hiking trail to the basalt organs starts at the end of the garden.", "There is private free parking.", "The fireplace keeps evenings warm.", "The pool can be used until the end of September."] },
    directDiscountLabel: "price advantage vs booking portals", directBenefits: ["Direct contact with your host", "Fast confirmation", "Flexible assistance"], bookingCta: "Prices & availability", contactCta: "Enquire in writing", whatsappCta: "WhatsApp"
  },
  de: {
    heroLead: ["Entschleunigen. Abschalten.", "Wählen Sie das Dandelion-Haus, das zu Ihnen passt."], heroValueAria: "Sehen Sie, was der Preisvorteil von 8 % bedeutet", heroValueLabel: "Preisvorteil · Details", heroValueAction: "DETAILS ANSEHEN", bookingBadge: "Direkt buchen und sparen!",
    benefitsAria: "Vorteile der Direktbuchung", benefitsKicker: "DIREKTBUCHUNG", benefitsTitle: "Direkt buchen lohnt sich", benefitsLead: "Die Vorteile der Direktbuchung:", benefits: ["8 % Preisvorteil gegenüber Portalen", "Sofortige Kartenzahlung", "Schneller, transparenter Buchungsablauf", "Direkter Kontakt zum Gastgeber"],
    priceDialogKicker: "DIREKTBUCHUNG", priceDialogClose: "Schließen", priceDialogTitle: "Direkt buchen lohnt sich", priceDialogIntro: "Verfügbarkeit und Preise sehen Sie direkt auf unserer eigenen Buchungsseite.", priceDialogStat: "Preisvorteil gegenüber Buchungsportalen", priceDialogBenefits: ["Direkter Kontakt zum Gastgeber", "Schnelle Bestätigung", "Flexible Abwicklung"], priceDialogCta: "Preise & Verfügbarkeit",
    moodKicker: "WARUM DANDELION IM HERBST?", moodTitle: "Der Herbst fühlt sich hier anders an.", moodIntro: "Wein, Spaziergänge, Fahrradtouren, Zeit am Pool und die Entdeckung des Balaton-Oberlands — verschiedene Häuser, dasselbe Dandelion-Gefühl.", selectionAria: "Tipps für die Auswahl", selectionKicker: "HERBSTIDEEN FÜR ZWEI", selectionBullets: ["Wein: Entdecken Sie die Weingüter der Umgebung und genießen Sie gemeinsam das Balaton-Oberland.", "Fahrräder: Bei uns können Sie Fahrräder leihen und auf dem Radweg am Balaton losfahren.", "Wanderungen und aktive Zeit in den Hügeln des Balaton-Oberlands.", "Ein romantischer Spaziergang am Mühlenteich von Tapolca.", "Herbststimmung in Badacsony, Panorama und Wein vom Hang.", "Entspannen Sie am Pool, der bis Ende September genutzt werden kann.", "Champagner und Blumen können auf Wunsch vorbereitet werden.", "Die Basaltorgeln des Szent György-Berges.", "Ein besonderes Abendessen im Taberna Infinitó, dem Panorama-Restaurant am Szent György-Berg.", "Wunderbare Ausblicke vom Szent György-Berg auf den Balaton, Szigliget und Badacsony.", "Das Folly-Arboretum und das Festetics-Schloss in Keszthely."],
    moodCards: [{ label: "PANORAMA", title: ["Morgen beginnt", "anders."], copy: "Panorama, Terrasse und Ruhe." }, { label: "GEMÜTLICHKEIT", title: ["Draußen kühl.", "Drinnen warm."], copy: "Kamin, eigener Raum und lange Abende." }, { label: "WEINREGION", title: ["Ein Glas Wein.", "Ein langer Abend."], copy: "Weingüter, ruhige Nachmittage und gute Gespräche." }],
    pickerTitle: "Welches Haus passt zu Ihnen?", pickerLead: "Diese Häuser eignen sich für unterschiedliche Herbstauszeiten — wählen Sie einfach das, das Ihnen am besten gefällt.", houseLabel: "Dieses Haus passt, wenn…", houseWhy: "Warum wir es empfehlen", houseView: "Haus ansehen", recommendations: { d2: "mehr Raum und ein Kamin", fugehaz: "panoramische Auszeit zu zweit", zsalya: "intimer Rückzugsort", szololiget: "kleineres, ruhigeres Haus", vintage: "ruhige Abende am Balaton", koveskal: "Dorf- und Weinregion-Ruhe", royal_homes: "Balaton und Jacuzzi", szepvolgyi: "großes Balaton-Panorama" }, houseBullets: { d2: ["Sie Herbstabende am Kamin verbringen möchten.", "Sie gemeinsam in einer gut ausgestatteten Küche kochen möchten.", "Ruhe und Stille wichtig sind.", "Schnelles WLAN wichtig ist.", "Der Pool bis Ende September genutzt werden kann."], fugehaz: ["Sie mit Blick auf die Zeugenberge Kaffee trinken und den Sonnenaufgang genießen möchten.", "Schnelles WLAN wichtig ist.", "Am Ende des Gartens ein Wanderweg zu den Basaltorgeln beginnt.", "Ein eigener kostenloser Parkplatz vorhanden ist.", "Der Kamin die Abende wärmt.", "Der Pool bis Ende September genutzt werden kann."] },
    directDiscountLabel: "Preisvorteil gegenüber Buchungsportalen", directBenefits: ["Direkter Kontakt zum Gastgeber", "Schnelle Bestätigung", "Flexible Abwicklung"], bookingCta: "Preise & Verfügbarkeit", contactCta: "Schriftlich anfragen", whatsappCta: "WhatsApp"
  },
  cs: {
    heroLead: ["Zpomalte. Vypněte.", "Vyberte si dům Dandelion, který vám bude nejlépe vyhovovat."], heroValueAria: "Zjistit, co znamená 8% cenová výhoda", heroValueLabel: "cenová výhoda · podrobnosti", heroValueAction: "ZJISTIT VÍCE", bookingBadge: "Rezervujte přímo a ušetřete!",
    benefitsAria: "Výhody přímé rezervace", benefitsKicker: "PŘÍMÁ REZERVACE", benefitsTitle: "Přímá rezervace se vyplatí", benefitsLead: "Výhody přímé rezervace:", benefits: ["8% cenová výhoda oproti portálům", "Okamžitá platba kartou", "Rychlý a přehledný rezervační proces", "Přímý kontakt s hostitelem"],
    priceDialogKicker: "PŘÍMÁ REZERVACE", priceDialogClose: "Zavřít", priceDialogTitle: "Přímá rezervace se vyplatí", priceDialogIntro: "Volné termíny a ceny si prohlédnete přímo v našem rezervačním systému.", priceDialogStat: "cenová výhoda oproti portálům", priceDialogBenefits: ["Přímý kontakt s hostitelem", "Rychlé potvrzení", "Flexibilní komunikace"], priceDialogCta: "Ceny a volné termíny",
    moodKicker: "PROČ DANDELION NA PODZIM?", moodTitle: "Podzim je tu jiný.", moodIntro: "Víno, výlety, cyklistika, odpočinek u bazénu a objevování Balatonské vrchoviny — různé domy, stejný zážitek Dandelion.", selectionAria: "Tipy pro výběr", selectionKicker: "PODZIMNÍ TIPY PRO DVA", selectionBullets: ["Víno: objevte místní vinařství a společně si užijte atmosféru Balatonské vrchoviny.", "Cyklistika: půjčte si u nás kola a vyrazte po cyklostezce kolem Balatonu.", "Výlety a aktivní odpočinek v kopcích Balatonské vrchoviny.", "Romantická procházka u Tapolckého Malom-tó.", "Podzimní Badacsony, panorama a víno ze svahu.", "Odpočinek u bazénu, který lze využívat do konce září.", "Šampaňské a květiny připravíme na vyžádání.", "Čedičové varhany Szent György-hegy.", "Výjimečná večeře v panoramatické restauraci Taberna Infinitó na Szent György-hegy.", "Nádherné výhledy ze Szent György-hegy na Balaton, Szigliget a Badacsony.", "Arboretum Folly a Festeticsův zámek v Keszthely."],
    moodCards: [{ label: "PANORAMA", title: ["Ráno začíná", "jinak."], copy: "Výhled, terasa a klid." }, { label: "ÚTULNOST", title: ["Venku chladno.", "Uvnitř teplo."], copy: "Krb, vlastní prostor a dlouhé večery." }, { label: "VINAŘSKÁ OBLAST", title: ["Sklenka vína.", "Dlouhý večer."], copy: "Vinařství, pomalá odpoledne a společné rozhovory." }],
    pickerTitle: "Který dům se k vám hodí?", pickerLead: "Tyto domy se hodí pro různé podzimní pobyty — vyberte si ten, který vás nejvíce osloví.", houseLabel: "Vyberte tento dům, pokud…", houseWhy: "Proč ho doporučujeme", houseView: "Prohlédnout dům", recommendations: { d2: "více prostoru a krb", fugehaz: "panoramatický pobyt pro dva", zsalya: "intimnější útočiště", szololiget: "menší a klidnější dům", vintage: "klidné večery u Balatonu", koveskal: "vesnický klid vinařské oblasti", royal_homes: "Balaton a vířivka", szepvolgyi: "velké panorama Balatonu" }, houseBullets: { d2: ["Chcete podzimní večery u krbu.", "Chcete společně vařit v pohodlné vybavené kuchyni.", "Je pro vás důležitý klid.", "Potřebujete rychlé Wi-Fi.", "Bazén lze využívat do konce září."], fugehaz: ["Chcete snídat s výhledem na svědecké hory a pozorovat východ slunce.", "Potřebujete rychlé Wi-Fi.", "Na konci zahrady začíná stezka k čedičovým varhanám.", "K dispozici je vlastní bezplatné parkování.", "Krb zpříjemní večery.", "Bazén lze využívat do konce září."] },
    directDiscountLabel: "cenová výhoda oproti rezervačním portálům", directBenefits: ["Přímý kontakt s hostitelem", "Rychlé potvrzení", "Flexibilní komunikace"], bookingCta: "Ceny a volné termíny", contactCta: "Napsat dotaz", whatsappCta: "WhatsApp"
  },
  sk: {
    heroLead: ["Spomaľte. Vypnite.", "Vyberte si dom Dandelion, ktorý vám bude najviac vyhovovať."], heroValueAria: "Zistiť, čo znamená 8 % cenová výhoda", heroValueLabel: "cenová výhoda · podrobnosti", heroValueAction: "ZISTIŤ VIAC", bookingBadge: "Rezervujte priamo a ušetrite!",
    benefitsAria: "Výhody priamej rezervácie", benefitsKicker: "PRIAMA REZERVÁCIA", benefitsTitle: "Priama rezervácia sa oplatí", benefitsLead: "Výhody priamej rezervácie:", benefits: ["8 % cenová výhoda oproti portálom", "Okamžitá platba kartou", "Rýchly a prehľadný rezervačný proces", "Priamy kontakt s hostiteľom"],
    priceDialogKicker: "PRIAMA REZERVÁCIA", priceDialogClose: "Zavrieť", priceDialogTitle: "Priama rezervácia sa oplatí", priceDialogIntro: "Voľné termíny a ceny si pozriete priamo v našom rezervačnom systéme.", priceDialogStat: "cenová výhoda oproti rezervačným portálom", priceDialogBenefits: ["Priamy kontakt s hostiteľom", "Rýchle potvrdenie", "Flexibilná komunikácia"], priceDialogCta: "Ceny a voľné termíny",
    moodKicker: "PREČO DANDELION NA JESEŇ?", moodTitle: "Jeseň je tu iná.", moodIntro: "Víno, výlety, bicyklovanie, oddych pri bazéne a objavovanie Balatonskej vrchoviny — rôzne domy, rovnaký zážitok Dandelion.", selectionAria: "Tipy na výber", selectionKicker: "JESENNÉ TIPY PRE DVOCH", selectionBullets: ["Víno: objavte miestne vinárstva a vychutnajte si atmosféru Balatonskej vrchoviny.", "Bicyklovanie: požičajte si u nás bicykle a vyrazte po cyklotrase pri Balatone.", "Výlety a aktívny oddych v kopcoch Balatonskej vrchoviny.", "Romantická prechádzka pri Tapolčianskom Malom jazere.", "Jesenný Badacsony, panoráma a víno zo svahu.", "Oddych pri bazéne, ktorý sa dá využívať do konca septembra.", "Šampanské a kvety pripravíme na požiadanie.", "Čadičové organy Szent György-hegy.", "Výnimočná večera v panoramatickej reštaurácii Taberna Infinitó na Szent György-hegy.", "Nádherné výhľady zo Szent György-hegy na Balaton, Szigliget a Badacsony.", "Arborétum Folly a Festeticsov zámok v Keszthely."],
    moodCards: [{ label: "PANORÁMA", title: ["Ráno sa začína", "inak."], copy: "Výhľad, terasa a ticho." }, { label: "ÚTULNOSŤ", title: ["Vonku chladno.", "Vnútri teplo."], copy: "Krb, vlastný priestor a dlhé večery." }, { label: "VÍNNA OBLASŤ", title: ["Pohár vína.", "Dlhý večer."], copy: "Vinárstva, pomalé popoludnia a spoločné rozhovory." }],
    pickerTitle: "Ktorý dom sa k vám hodí?", pickerLead: "Tieto domy sa hodia na rôzne jesenné pobyty — vyberte si ten, ktorý vás najviac osloví.", houseLabel: "Vyberte si tento dom, ak…", houseWhy: "Prečo ho odporúčame", houseView: "Pozrieť si dom", recommendations: { d2: "viac priestoru a krb", fugehaz: "panoramatický pobyt pre dvoch", zsalya: "intímnejšie útočisko", szololiget: "menší a pokojnejší dom", vintage: "pokojné večery pri Balatone", koveskal: "dedinský pokoj vinárskej oblasti", royal_homes: "Balaton a vírivka", szepvolgyi: "veľká panoráma Balatonu" }, houseBullets: { d2: ["Chcete jesenné večery pri krbe.", "Chcete spoločne variť v pohodlnej vybavenej kuchyni.", "Je pre vás dôležitý pokoj.", "Potrebujete rýchle Wi-Fi.", "Bazén sa dá využívať do konca septembra."], fugehaz: ["Chcete raňajkovať s výhľadom na svedecké vrchy a obdivovať východ slnka.", "Potrebujete rýchle Wi-Fi.", "Na konci záhrady začína chodník k čadičovým orgánom.", "K dispozícii je vlastné bezplatné parkovanie.", "Krb spríjemní večery.", "Bazén sa dá využívať do konca septembra."] },
    directDiscountLabel: "cenová výhoda oproti rezervačným portálom", directBenefits: ["Priamy kontakt s hostiteľom", "Rýchle potvrdenie", "Flexibilná komunikácia"], bookingCta: "Ceny a voľné termíny", contactCta: "Napísať otázku", whatsappCta: "WhatsApp"
  }
};
...
export function getLocalizedAutumnMultiHouses(lang: AutumnCampaignLang, audience: "couple" | "family" = "family") {
  const copy = audience === "family" ? familyCopyByLang[lang] : coupleCopyByLang[lang];
  return autumnMultiHouseByAudience[audience].map((house) => ({
    ...house,

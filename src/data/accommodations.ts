...
export const accommodations: Accommodation[] = [
  {
    ...
    description: "Tágas kisapáti vendégház nagyobb családoknak vagy baráti társaságoknak, három hálóval, két fürdővel, terasszal és nyári Panorama Pool használattal a szezonban.",
  ...
  },
  {
    ...
    url: "/dandelion-d2/",
    location: "Kisapáti / Balaton-felvidék",
    description: "Családbarát kisapáti apartman nagy kerttel, fedett terasszal, kandallóval és nyári Panorama Pool használattal a szezonban.",
    hoverText: "4-6 főre, kerttel, terasszal és Panorama Pool hozzáféréssel.",

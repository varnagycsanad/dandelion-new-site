...
const buildLanguageLinks = (active: "hu" | "en" | "de" | "cs" | "sk") => [
  ...
  { label: "CZ", href: "/cs/panorama-pool/", isActive: active === "cs" },
...
export const poolGuideContentByLocale: Record<"hu" | "en" | "de" | "cs" | "sk", PoolGuideContent> = {
  hu: {
    ...
    primaryActionLabel: "Víz és időjárás",
    secondaryActionLabel: "Rövid szabályok",
    heroNoteStrong: "Csak a D1, D2 és Fügeház vendégeinek.",
    heroNoteText: "Ha siettek, először a vízhőmérsékletet, az időjárást és a rövid szabályokat nézzétek meg.",
    liveEyebrow: "Víz és időjárás",
    liveTitle: "Milyen most a medence?",
    liveText: "Itt látjátok a vízhőmérsékletet és a friss időjárási adatokat, hogy könnyebb legyen eldönteni, belefér-e most egy fürdés.",
    liveFrameTitle: "Panorama Pool aktuális adatai",
  ...
  en: {
    ...
    primaryActionLabel: "Water and weather",
    secondaryActionLabel: "Quick rules",
    heroNoteStrong: "Only for D1, D2 and Fügeház guests.",
    heroNoteText: "If you are in a hurry, start with the water temperature, the weather alerts and the quick rules below.",
    liveEyebrow: "Water and weather",
    liveTitle: "What is the pool like right now?",
    liveText: "Here you can see the current water temperature and fresh weather readings before you head out for a swim.",
    liveFrameTitle: "Panorama Pool current data",
  ...
  de: {
    ...
    primaryActionLabel: "Wasser und Wetter",
    secondaryActionLabel: "Kurze Regeln",
    heroNoteStrong: "Nur für Gäste von D1, D2 und Fügeház.",
    heroNoteText: "Wenn es schnell gehen soll, schaut zuerst auf Wassertemperatur, Wetterhinweise und die kurzen Regeln.",
    liveEyebrow: "Wasser und Wetter",
    liveTitle: "Wie ist der Pool gerade?",
    liveText: "Hier seht ihr die aktuelle Wassertemperatur und frische Wetterdaten, bevor ihr zum Pool geht.",
    liveFrameTitle: "Panorama Pool aktuelle Daten",
  ...
  cs: {
    ...
    primaryActionLabel: "Voda a počasí",
    secondaryActionLabel: "Krátká pravidla",
    heroNoteStrong: "Jen pro hosty D1, D2 a Fügeház.",
    heroNoteText: "Když spěcháte, podívejte se nejdřív na teplotu vody, upozornění na počasí a krátká pravidla.",
    liveEyebrow: "Voda a počasí",
    liveTitle: "Jak to u bazénu vypadá právě teď?",
    liveText: "Tady uvidíte aktuální teplotu vody a čerstvé údaje o počasí, než se vydáte k bazénu.",
    liveFrameTitle: "Panorama Pool aktuální údaje",
  ...
  sk: {
    ...
    primaryActionLabel: "Voda a počasie",
    secondaryActionLabel: "Krátke pravidlá",
    heroNoteStrong: "Len pre hostí D1, D2 a Fügeház.",
    heroNoteText: "Ak sa ponáhľate, najskôr si pozrite teplotu vody, upozornenia na počasie a krátke pravidlá.",
    liveEyebrow: "Voda a počasie",
    liveTitle: "Ako to pri bazéne vyzerá práve teraz?",
    liveText: "Tu uvidíte aktuálnu teplotu vody a čerstvé údaje o počasí ešte predtým, než pôjdete k bazénu.",
    liveFrameTitle: "Panorama Pool aktuálne údaje",

...
- `AUT-005` `[ ]` Feladat: közös szolgáltatásblokk es közvetlen foglalási előnyök blokk struktúrájának meghatározása; Függőség: `CNT-002`, `CNT-003`; Várható fájlok vagy rendszer: offer template, offer data; Elfogadási feltétel: a két landing ugyanazt a blokklogikát használja; Megjegyzés: az állítások igazoltsági szintje külön mezőként kezelendő.
